...
export const getStockSearchTrackingStatistics = createAsyncThunk("GET/StockSearchTrackingStatistics", async () => {
    ...
    const data = response.data.map((item, index) => {
        ...
        return {
            ...
            D_Day: dDay,
            윌리엄스_5: `${parseInt(item.최소값.윌리엄스_5)} - ${parseInt(item.최대값.윌리엄스_5)}`,
            윌리엄스_7: `${parseInt(item.최소값.윌리엄스_7)} - ${parseInt(item.최대값.윌리엄스_7)}`,
            윌리엄스_14: `${parseInt(item.최소값.윌리엄스_14)} - ${parseInt(item.최대값.윌리엄스_14)}`,
            코스피200_7: `${parseInt(item.최소값.코스피200_7)} - ${parseInt(item.최대값.코스피200_7)}`,
            코스피200_14: `${parseInt(item.최소값.코스피200_14)} - ${parseInt(item.최대값.코스피200_14)}`,
            코스피200_20: `${parseInt(item.최소값.코스피200_20)} - ${parseInt(item.최대값.코스피200_20)}`,
            코스피_7: `${parseInt(item.최소값.코스피_7)} - ${parseInt(item.최대값.코스피_7)}`,
            코스피_14: `${parseInt(item.최소값.코스피_14)} - ${parseInt(item.최대값.코스피_14)}`,
            코스피_20: `${parseInt(item.최소값.코스피_20)} - ${parseInt(item.최대값.코스피_20)}`,
            코스닥_7: `${parseInt(item.최소값.코스닥_7)} - ${parseInt(item.최대값.코스닥_7)}`,
            코스닥_14: `${parseInt(item.최소값.코스닥_14)} - ${parseInt(item.최대값.코스닥_14)}`,
            코스닥_20: `${parseInt(item.최소값.코스닥_20)} - ${parseInt(item.최대값.코스닥_20)}`,
        }
    })
    return data;
});
