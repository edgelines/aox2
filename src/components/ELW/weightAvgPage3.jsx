...
export default function WeightAvgPage3({ swiperRef, ELW_monthTable, ELW_CallPutRatio_Maturity, ElwWeightedAvgCheck, Exchange, MarketDetail }) {
    ...
    const fetchData1Day = async () => {
        ...
        await axios.get(JSON + "/MoneyIndex").then((response) => {
            ...
            setMoneyIndex([{
                ...
                type: 'ema', animation: false, yAxis: 0, linkedTo: 'candlestick', marker: { enabled: false }, showInLegend: true,
                color: '#efe9e9ed',
                ...
                type: 'ema', animation: false, yAxis: 0, linkedTo: 'candlestick', marker: { enabled: false }, showInLegend: true, visible: false,
                color: 'coral',
                dashStyle: 'shortdash',//라인 스타일 지정 옵션
                name: '9',
                lineWidth: 1,
    ...
    return (
        <Grid container spacing={1} >
            ...
            <Grid item xs={6}>
                <Box sx={{ fontSize: '1.3rem', fontWeight: 'bold', zIndex: 5, backgroundColor: 'rgba(0, 0, 0, 0.2)', position: 'absolute', transform: 'translate(36.5vw, 9vh)' }}>
                    {Exchange.value ?
                        <>
                ...
                <Box sx={{ fontSize: '1.3rem', fontWeight: 'bold', zIndex: 5, backgroundColor: 'rgba(0, 0, 0, 0.2)', position: 'absolute', transform: 'translate(35vw, 10.5vh)' }}>
            ...
            <Grid item xs={6}>
                ...
                <Box sx={{ position: 'absolute', transform: 'translate(2.6vw, -30vh)', backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
