    ...
    useEffect(() => {
        if (chartRef.current) {
            ...
            Highcharts.chart(chartRef.current, {
                ...
                legend: {
                    align: 'right', borderWidth: 0, verticalAlign: 'top', symbolRadius: 0, symbolWidth: 6, symbolHeight: 10, itemDistance: 6, itemStyle: { color: '#efe9e9ed', fontSize: '11px', }, itemHiddenStyle: { color: "#000000" }, itemHoverStyle: { color: "gold" }, x: 5, y: -9,
